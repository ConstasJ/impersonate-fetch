...
interface InspectedFingerprintPayload {
  alpnOrProtocol: string;
  headerOrder: string[];
...
function inspectFingerprintPayload(payload: Record<string, unknown>): InspectedFingerprintPayload {
